<?php
	...
	$sql="SELECT * FROM selllist RIGHT JOIN product ON selllist.productname = product.name WHERE id = '".$_GET["id"]."' ";
					...
					<aside class="sidebar">
						<div class="row">
							...
							<div class="col-md-12 side">
								<h3>ผู้จำหน่าย</h3>
								<ul>
									<li><i class="icon-user"></i><a href="#"><?php echo $objResult1["username"] ?></a></li>
								</ul>
							</div>
							<a class="btn btn-primary" href="#">สถานที่ติดต่อ</a>
						</div>
					</aside>
				</div>
			</div>
