<?php
	...
	$sql1="SELECT * FROM selllist RIGHT JOIN product ON selllist.productname = product.name WHERE NOT (type='เครื่องมือ' OR type='ปุ๋ย' OR type='ผัก' OR type='ผลไม้') AND name like '%{$_POST['itemname']}%' ";
